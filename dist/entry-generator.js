var Base, BaseModel, ClassInfo, ESCodeGenerator, EntryGenerator, EntryGeneratorInput, Facade, JSCodeGenerator, MasterDataResource, Path, camelize, fs, ref, requireFile,
...
EntryGeneratorInput = (function() {
  ...
  EntryGeneratorInput.prototype.createFacade = function() {
    var allModules, i, len, moduleName, ref1;
    allModules = {};
  ...
  EntryGeneratorInput.prototype.getModulesClasses = function() {
    var i, len, moduleName, modulePath, modules, ref1;
    modules = {};
    ref1 = this.getModuleNames();
    for (i = 0, len = ref1.length; i < len; i++) {
      moduleName = ref1[i];
  ...
  EntryGeneratorInput.prototype.getPreferredFactoryNames = function() {
    var classInfo, classes, factories, i, j, k, len, len1, modName, ref1, ref2, v;
    factories = {};
    ref1 = this.coreClasses;
    for (i = 0, len = ref1.length; i < len; i++) {
      classInfo = ref1[i];
...
EntryGenerator = (function() {
  ...
  EntryGenerator.prototype.getPackedData = function() {
    var coreClasses, facadeClassName, factories, masterJSONStr, modules, ref1;
    ref1 = this.input, factories = ref1.factories, coreClasses = ref1.coreClasses, modules = ref1.modules, masterJSONStr = ref1.masterJSONStr, facadeClassName = ref1.facadeClassName;
