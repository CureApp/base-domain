'use strict';
var DomainError, EntityPool, FixtureLoader, Scope, debug, isPromise,
...
FixtureLoader = (function() {
  ...
  FixtureLoader.prototype.load = function(options) {
    var e, error, ext, file, fixtureDir, fs, fx, j, k, l, len, len1, len2, modelName, modelNames, names, path, ref, ref1, ref2, ref3;
    if (options == null) {
      options = {};
    }
  ...
  FixtureLoader.prototype.readTSV = function(fixtureDir, file) {
    var data, fs, i, id, j, k, len, len1, line, lines, name, names, obj, objs, tsv, value;
    fs = this.facade.constructor.fs;
    objs = {};
