...
BaseModel = (function(superClass) {
  ...
  @method includeAll
  @param {Object} [options]
  @param {Boolean|Object} [options.recursive] recursively include models or not.
  @return {Promise}
   */
  ...
  BaseModel.prototype.include = function(options) {
    ...
    return Promise.all(promises).then((function(_this) {
      return function() {
        var i, len, model, modelProp, propInfo, ref1, results1;
        if (!options.recursive) {
          return true;
        }
