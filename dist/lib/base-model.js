var Base, BaseModel, Id, Includer, ModelProps, TypeInfo,
...
BaseModel = (function(superClass) {
  ...
  BaseModel.getModelProps = function() {
    return this._props != null ? this._props : this._props = new ModelProps(this.properties, this.getFacade());
  };
  ...
  BaseModel.prototype.set = function(prop, value) {
    ...
    if (modelProps.isEntity(prop)) {
      ...
      this[typeInfo.idPropName] = new Id(value != null ? value.id : void 0);
    } else if (modelProps.isId(prop)) {
      this[prop] = new Id(value);
      submodelProp = modelProps.submodelOf(prop);
      if ((this[submodelProp] != null) && !this[prop].equals(this[submodelProp].id)) {
