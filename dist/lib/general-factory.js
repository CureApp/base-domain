...
GeneralFactory = (function() {
  ...
  GeneralFactory.prototype.createFromObject = function(obj, options) {
    var ModelClass, defaultValue, i, len, model, prop, ref, subModelName, typeInfo, value;
    if (options == null) {
      options = {};
    }
    ...
    for (prop in obj) {
      ...
      if ((value == null) && (typeInfo != null ? typeInfo.optional : void 0)) {
        continue;
      }
      if (subModelName = typeInfo != null ? typeInfo.model : void 0) {
