...
MasterRepository = (function(superClass) {
  ...
  function MasterRepository() {
    ...
    memoryResource = master.getMemoryResource(this.constructor.modelName);
    if (memoryResource == null) {
      throw this.error('masterDataNotFound', "No master data of '" + this.constructor.modelName + "' at " + (this.constructor.getName()) + ".\nCheck the contents of " + (this.getFacade().master.masterJSONPath) + ".");
    }
